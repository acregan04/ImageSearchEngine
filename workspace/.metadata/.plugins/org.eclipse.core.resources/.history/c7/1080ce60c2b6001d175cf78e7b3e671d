...
public class GUI extends JFrame {
	...
	public GUI() {
		...
		setContentPane(contentPane);
			contentPane.setLayout(new MigLayout("", "[55.00px][256px][88.00][][][][128px][128px][128px][128px][128px][][][31.00][][9.00]", "[90px][128px][][128px][128px][][][][][][][]"));
			...
			contentPane.add(btnBrowse, "cell 1 1,alignx center");
			...
			contentPane.add(btnSearch, "cell 1 10,alignx center,growy");			
			...
			btnSearch.addMouseListener(new MouseAdapter() {
				...
				public void mouseClicked(MouseEvent e) {
					...
					try {
						//proImgs = new ArrayList<Image>(images.details(lblSearchImg.getIcon(), lblQImg.getText()));
						...
						JOptionPane.showMessageDialog(null, "No search image selected", "Warning", JOptionPane.WARNING_MESSAGE);
						//e1.printStackTrace();
					}			
				}
			});			
